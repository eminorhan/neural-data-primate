...
if __name__ == '__main__':
    ...
    ds.push_to_hub("eminorhan/churchland", max_shard_size="64GB", token=True)  # set max_shard_size to something big to deal with bug in push_to_hub (https://github.com/huggingface/datasets/issues/6602)