...
def get_args_parser():
    ...
    parser.add_argument('--data_dir',default="sub-Indy",type=str, choices=["sub-Indy"], help='Data directory')
    return parser
...
if __name__ == '__main__':
    ...
    for file_name in nwb_files:
        ...
        with NWBHDF5IO(file_path, "r") as io:
            ...
            # # behavior (not extracting these for now)
    ...
    ds.push_to_hub("eminorhan/mc-rtt", _folder_mapping[os.path.basename(args.data_dir)], token=True)
